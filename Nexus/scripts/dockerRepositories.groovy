...
// Сreate hosted repo and expose via https to allow deployments
repository.createDockerHosted('my-docker-host1', null, 62283)


// Сreate hosted repo and expose via http to allow deployments
repository.createDockerHosted('my-docker-host2', 8283,null)

// Сreate proxy repo of Docker Hub and enable v1 to get search to work
...
repository.createDockerProxy('my-docker-proxy',                   // name
 ...
 // Сreate group and allow access via https
